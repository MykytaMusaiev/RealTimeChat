  ...
  return (
    <main className="flex flex-col h-screen max-h-screen overflow-hidden">
      <header className="border-b border-zinc-800 p-4 flex items-center justify-between bg-zinc-900/30">
        ...
        <button className="text-xs bg-zinc-800 hover:bg-red-600 px-3 py-0.5 rounded text-zinc-400 hover:text-white font-bold transition-all group flex items-center gap-2 disabled:opacity-50">
        ...
        <div className="flex gap-4">
          <div className="flex-1 relative group">
            ...
            <input
              ...
              autoFocus
              type="text"
              className="w-full bg-black border border-zinc-800 focus:border-zinc-700 focus:outline-none placeholder:text-zinc-700 py-3 pl-8 pr-4 text-sm"
            />
